      ...
      <div className="max-w-3xl mx-auto px-4 py-6 pb-20">
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          ...
          <TabsContent value="connected" className="space-y-5 mt-0">
            <Section title="সংযুক্ত অ্যাকাউন্ট" description="তৃতীয় পক্ষের সেবার সাথে সংযোগ করুন">
              {/* Google */}
              <Row
                label="Google"
                ...
                action={
                  googleConnected ? (
                    ...
                    >
                      ...
                      {connectingGoogle ? "সংযোগ হচ্ছে..." : "Google সংযুক্ত করুন"}
                    </Button>
                  )
                }
              />
              {/* GitHub — not yet supported in Lovable Cloud */}
              <Row
                label="GitHub"
                description="শীঘ্রই পাওয়া যাবে"
                action={
                  <Button variant="outline" size="sm" className="gap-1.5 opacity-40 cursor-not-allowed" disabled>
            ...
            <Section title="সাইন-ইন পদ্ধতি" description="আপনার অ্যাকাউন্টে সংযুক্ত লগইন পদ্ধতি">
              <Row
                label="ইমেইল / পাসওয়ার্ড"
